...
<!--             <td style="width:5%;">方法</td> -->
          ...
          <c:forEach items="${data.testCaseList}" var="o" varStatus="status">
         <tr class="hang01">
		    <td>
		    ${status.count}
		    </td>
...
<!-- 		    </td> -->
		    ...
		    <input type="button" class="gaic" value="删除" onclick="window.location.href='<%=path %>/case/deletecase.do?caseId=${o.uuid }'">
		    </td>
		    </tr>
		    </c:forEach>
        </table><br>
		...
		&nbsp;第<font color="red">${data.pageNum}<font><font color="black">页&nbsp;共${data.totalPages }页</font>&nbsp;&nbsp;
          ...
          <input type="hidden" name="pag"  id="pag"  value="${data.pageNum}">
        </div>
	</form>
